...
import org.elzacontiero.m3assessments.vendingmachinespring.dao.InventoryDao;
import org.elzacontiero.m3assessments.vendingmachinespring.dao.InventoryDaoFileImpl;
...
public class VendingMachine implements CommandLineRunner {
    ...
    // the original code using Composition
    // InventoryDao inventory  = new InventoryDaoFileImpl();
    // Now the new code only holds a reference.
    InventoryDao inventory;

    // Dependency injection here vvv
